...
class Ui_PlanningCenterDialog(object):
    ...
    def retranslate_ui(self, planningcenter_dialog):
        ...
        self.update_existing_button.setText(translate('PlanningCenterPlugin.PlanningCenterForm', 'Update'))
        self.update_existing_button.setToolTip(translate('PlanningCenterPlugin.PlanningCenterForm', 'Update Existing Service'))
